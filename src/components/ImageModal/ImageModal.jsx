        ...
        <AnimatePresence>
            ...
            >
                ...
                >
                    ...
                    <div className="relative w-full h-full max-w-[95vw] max-h-[90vh] bg-white dark:bg-gray-900 rounded-lg shadow-2xl overflow-auto">
                        <div className="p-4">
                            <motion.img
                                key={currentIndex}
                        ...
                        {/* Fixed Image Info */}
                        <div className="sticky bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 via-black/60 to-transparent p-4">
                    ...
                    {images.length > 1 && (
                        <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2">
                            <div className="flex justify-center space-x-2 bg-black/50 backdrop-blur-sm rounded-full px-4 py-2">

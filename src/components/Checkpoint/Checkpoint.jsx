...
import { FaDownload, FaEnvelope, FaCheck, FaStar } from 'react-icons/fa';
          ...
          {checkpoints.map((checkpoint, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Icon */}
                <div className={`w-16 h-16 rounded-xl flex items-center justify-center mb-4 transition-all duration-300 ${checkpoint.completed
                ...
                {/* Status */}
                <div className={`mt-4 text-xs font-semibold uppercase tracking-wide ${checkpoint.completed
                    ? 'text-primary dark:text-primary-light'

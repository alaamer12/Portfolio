...
const OpenSourceHeader = memo(({ settings }) => (
    ...
    >
        ...
        <p className="text-gray-600 dark:text-gray-300 text-sm md:text-base max-w-2xl mx-auto">
            Discover my published Python packages and libraries that enhance data engineering workflows, providing tools
            for dataset generation, data processing, and analytics applications.
        </p>
    </motion.div>
));
